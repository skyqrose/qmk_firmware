...
const key_override_t cmd_spc = ko_make_with_layers(MOD_MASK_CTRL, KC_SPC, LCMD_T(KC_SPC), custom_layer_mask);
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  _______, _______, _______, KC_LALT, KC_LCTL, LSFT_T(KC_BSPC),
                                     LCMD_T(KC_SPC), LT(L_NUM, KC_DEL), MO(L_SYS), XXXXXXX, XXXXXXX, XXXXXXX
  ),
